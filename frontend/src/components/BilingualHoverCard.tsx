  ...
  const popoverContent = (
    ...
    >
      ...
      {((language !== 'zh' && analogyEn) || (language !== 'en' && analogyZh)) && (
        <div className="p-3 prism-surface-subtle border-warning text-xs text-content-primary leading-relaxed shadow-sm">
          <div className="font-bold text-warning text-xs mb-1 flex items-center gap-1">
