...
export const DebateArena: React.FC<DebateArenaProps> = ({ debateData, isPlainTalk = false }) => {
  ...
  const handleCopyVerdict = () => {
    ...
    const snippet = `🏛️ **Prism Loop Multi-Agent Debate & CIO Verdict**\n` +
      ...
      (bear.downside_risk ? `⚠️ *Key Downside Risk*: ${bear.downside_risk}\n\n` : '\n') +
      `⚖️ **CIO Summary**: ${cio.judge_summary || "Ground-truth audit confirms solid FCF conversion and wide economic moat."}\n` +
